...
const { validOrderId } = require('../middleware/orders');
...
module.exports = (app, nextMain) => {
   ...
   */
  app.put('/orders/:orderId', [requireAuth, validOrderId], updateOrder);
   ...
   */
  app.delete('/orders/:orderId', [requireAuth, validOrderId], deleteOrder);
